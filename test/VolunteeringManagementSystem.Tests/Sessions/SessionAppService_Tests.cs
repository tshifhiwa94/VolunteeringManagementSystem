...
using Shouldly;
using Xunit;
using VolunteeringManagementSystem.Sessions;

namespace VolunteeringManagementSystem.Tests.Sessions
{
    public class SessionAppService_Tests : VolunteeringManagementSystemTestBase
    {
