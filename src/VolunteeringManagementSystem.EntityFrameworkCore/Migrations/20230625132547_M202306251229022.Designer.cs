...
namespace VolunteeringManagementSystem.Migrations
{
    ...
    [Migration("20230625132547_M202306251229022")]
    partial class M202306251229022
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VolunteeringManagementSystem.Domain.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VolunteeringManagementSystem.Domain.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VolunteeringManagementSystem.Domain.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VolunteeringManagementSystem.Domain.Skill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VolunteeringManagementSystem.Domain.StoredFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VolunteeringManagementSystem.Domain.TaskItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VolunteeringManagementSystem.Domain.VolunteerTaskEvaluation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("VolunteerTaskEvaluations");
                });
            ...
            modelBuilder.Entity("VolunteeringManagementSystem.Domain.Employee", b =>
                {
                    b.HasBaseType("VolunteeringManagementSystem.Domain.Person");

                    b.Property<string>("EmpoyeeNo")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("VolunteeringManagementSystem.Domain.Volunteer", b =>
                {
                    b.HasBaseType("VolunteeringManagementSystem.Domain.Person");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("VolunteeringManagementSystem.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("VolunteeringManagementSystem.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("VolunteeringManagementSystem.Domain.Message", b =>
                {
                    b.HasOne("VolunteeringManagementSystem.Domain.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("VolunteeringManagementSystem.Domain.TaskAssign", "TaskAssign")
                        .WithMany()
