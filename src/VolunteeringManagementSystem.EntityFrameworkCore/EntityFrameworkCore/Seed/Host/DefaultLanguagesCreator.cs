...
namespace VolunteeringManagementSystem.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly VolunteeringManagementSystemDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = VolunteeringManagementSystemConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(VolunteeringManagementSystemDbContext context)
        {
            _context = context;
        }
