...
namespace VolunteeringManagementSystem.Services.PersonService
{
    ...
    //        .ForMember(dto => dto.TitleText, opt => opt.MapFrom(src => src.Title != null && src.Title != 0 ? src.Title.GetnumDescription() : null))
    //        .ForMember(dto => dto.GenderText, opt => opt.MapFrom(src => src.Gender != null && src.Gender != 0 ? src.Gender.GetnumDescription() : null))
